...
int main() {
     ...
     * Тому ми викорситовуємо auto або можна ще std::function, але краше auto. Тобто якщо у нас буде
     * auto і зробимо три різні виклики, один з int, один з double і один зі std::string_view то
     * у компілятор згенерує три різні функції в залженості від переданого нами типу аргумента
     */
