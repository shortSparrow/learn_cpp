...
int main() {
     ...
     * для цього можна написати метод helper або зробити overload оператора <<
     *
     ...
     * Тож або треба не додавати другого << після std::cout << point1, або робити як ми зробили з return out
     */
     ...
     *
     * Якщо хоча б один параметр який треба користувач не введе то >> не зробить ніяких змін у переданому point,
