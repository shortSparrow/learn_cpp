...
int main() {
    ...
    */
     ...
     * Бо обмеження по пам'яті є лише у stack (на різних системах по рвзному, але по кілька мега байт)
     */
    // int stack[10000000];
    ...
    /**
     * Тут теж буде перемовнення, але що саме «з’їдає» пам'ять у цьому прикладі?
     ...
     *
     * Останнє що вивожить до помилки 43202
     *
     * Відповідь Gemini:
