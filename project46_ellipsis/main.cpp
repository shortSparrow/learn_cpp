 ...
 *
 *
 * Наступне, що нам потрібно зробити, це вказати списку на наші параметри ellipsis.
 ...
 * якщо візьмемо забагато, то отримаємо якесь значення зі смітника (garbage)
 *
 *
...
int main() {
     ...
     * int, але 1.0 - це double тож всі біти якими він записаний буде сприйнято як біти int числа
