...
int main() {
    ...
    *ptr = 7; // assign value of 7 to allocated memory
     ...
     *
     * Але після delete значення швидше за свсе все ще буде у тій комірці пам'яті куди ви його записали,
     ...
     *
     * Best practice
     * Ставити deleted pointers значення nullptr, окрім випадків, коли ми одразу визодимо зі скопупа
     ...
     * мати пам'яті для виконання запиту. Якщо це станесться то викличеться exception.
     *
     ...
     * буде висіти до закритят програми
     */
     ...
     * Оскільки C-stle array і просто std::array мають фіксовану довжину і вона повинна бути
