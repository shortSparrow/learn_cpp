...
void print_binary(unsigned int x) {
    /**
     * Порядок виводу у термінал буде зворотній, тобто з низу у верх (з початку 1, потім 0, потім 0, поітм 0)
     * 16 ->
     *    8 (print 0)
     *    4 (print 0)
     *    2 (print 0)
     ...
     * і ми можемо заупстити нашу функцію як для позитивного числа.
     *
     */
