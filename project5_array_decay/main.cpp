...
int main() {
    /**
     * У більшості випадків, коли у виразі використовується C-style array, масив буде неявно
     ...
     *
     * Тому що C-style arrays розпадаються (decay) на pointer у більшості випадків,
    ...
    /**
     * Висновок
     * C-style arrays варто уникати в більшості випадків, бо хоч вони і дають змогу передавати
     * "посилання", але не передають розміру масиву коли розпадаються (decay), тож це ускладнює з ними
     * роботу.
     */
