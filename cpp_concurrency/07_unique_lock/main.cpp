 ...
 * передати std::adopt_lock як другий аргумент конструктора, щоб об'єкт блокування керував блокуванням мутекса, ви також
 * можете передати std::defer_lock як другий аргумент, щоб вказати, що мьютекс повинен залишатися розблокованим під час побудови
 *
