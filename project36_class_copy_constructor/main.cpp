...
public:
    ...
    // Delete the copy constructor so no copies can be made. Заборонить використовувати constructor copy
...
int main() {
     ...
     * Fraction fCopy { f } працює неочікувано, саме тут і відбувається виклик копії конструктора
     ...
     * у змінних в оригінальному класі, тобто в нашому випадку numerator ініціалізовано значенням 5, а denominator - 3.
     *
     * Краще використовувати implicit copy constructor, тобто коли C++ робить його за нас ніє писати самому!
     */
