...
int main() {
     ...
     * і час життя тимчасового об'єкта поверненого getHello продовжується.
     *
     ...
     * Тут foo поверне не посилання, а саме значення
     */
     ...
     *
     * Висновок
     * Надавайте перевагу поверненню за посиланням (reference), а не за адресою (pointer), окрім випадків,
     ...
     * const чи constexpr опускається, так само і з reference. Keyword auto прибирає reference
     */
